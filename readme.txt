...
Rollerblade installs an annotation tool for you, your clients and your team to automatically take screenshots of your site and then submit them as a ticket with your comments.
...
2. Click Activate
3. Go to Rollerbladeapp.com and create an account. (You'll be asked to choose a subdomain on rollerbladeapp.com where your tickets will be stored. 
4. Go to the settings page on your rollerbladeapp.com account and enter the URL of your Wordpress installation to authorize it. 
5. Now, in your Wordpress installation, go to Settings ->Rollerblade in the WP Admin menu.
6. Enter the sub-domain you selected in step 3 to link your Wordpress Web Site to your Rollerbladeapp.com account. 
